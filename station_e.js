var station_e = {
    ...
    trashcan_e: function(player){
        if(player.game_data.states.inTrashcan_e !=='yes' && player.hasItem('悠遊卡')){
    ...
    throwCard: function(player){
        ...
        player.game_data.states.inTrashcan_e = 'yes';
